...
void mget_ms(unsigned long *time)
{
    ...
    /* 当前工程暂无统一毫秒时基接口，先提供单调递增时间戳以满足 DMP API。 */
    fake_ms += 5U;
}
//mpu6050,dmp初始化
//返回值:0,正常
